...
| ---------------------------- | --------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------- |
| **Important (conversation)** | Chat Input user turns; agent **final / result**; `ask_user` question (left) and operator reply (right); short permission-ask cues | Bright chat bubbles / primary text; Chat Input on the **opposite side** from the agent       | Conversation turns always; `ask_user` / permission cues from live WS (+ bootstrap replay while pending) |
