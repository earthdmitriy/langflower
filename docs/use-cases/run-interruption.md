...
| Provider idle/5xx → retry or Steer await      | [S6](#s6--recoverable-provider-failure-does-not-kill-steer)                                                                                     | **Shipped** (unit/scripted)                                                                                              | Real-provider Implementable proof remains open; runtime-wide node reload is TBD-008                                      |
