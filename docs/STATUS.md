...
| Right sidebar — feed (work log) | **partial** | `features/sidebar/` — chat-dense projection landed (epic 17); [feed-panel](features/feed-panel.md), [grok-feed](use-cases/grok-feed.md) **Partial** |
...
| UI work log + canvas chrome (node + wire) | **partial** | Chrome/execution folds **done**; feed chat-density **Partial** (epic 17) — [grok-feed](use-cases/grok-feed.md) / [feed-panel](features/feed-panel.md) |
...
| ---------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [feed-panel](features/feed-panel.md)                                                                                                                                   | **partial**                | Chat-density + draft/tool segments (**DONE** epic 34); composer shell layout (**DONE** epic 35); live-provider Implementable still open ([grok-feed](use-cases/grok-feed.md)) |
