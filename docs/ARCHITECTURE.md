...
| ------------------------------------ | -------------------- | ------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------- |
| Session chrome                       | snapshot only        | slim `session.state.snapshot`: `version`, effective redacted `langflowerConfig`, `dividerPositions`, `selectedNode` | divider and selection bridge facts                                                |
