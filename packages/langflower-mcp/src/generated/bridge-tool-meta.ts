...
export const BRIDGE_TOOL_META = {
	...
	'runner.output-emitted': {
		description:
			"Output port signal — {@link RuntimeRunnerEvent} with `kind === 'output-emitted'`.",
	...
	'runner.input-received': {
		description:
			"Input port signal — {@link RuntimeRunnerEvent} with `kind === 'input-received'` (wires, seeds).",
		typeExpr: 'RuntimeRunnerEvent',
		inputSchema: {
			type: 'object',
			description: 'TypeScript payload: RuntimeRunnerEvent',
	...
	'runner.done': {
		description:
			"Natural run end — {@link RuntimeRunnerEvent} with `kind === 'done'` (empty graph, {@link RuntimeNode.stopsRun}, or forced complete). Runner status becomes `'idle'`.",
		typeExpr: 'RuntimeRunnerEvent',
		inputSchema: {
			type: 'object',
			description: 'TypeScript payload: RuntimeRunnerEvent',
